...
export default function Navbar() {
	...
	return (
		<>
			<nav className="h-14 fixed top-0 w-full flex items-center justify-center navbar lg:justify-between px-12 shadow-lg z-50 transition-all duration-300 in-cover">
