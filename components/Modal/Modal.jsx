...
export default function Modal({ showModal, setShowModal, title }) {
  return (
    <>
      <div
        className={` ${
          showModal ? " opacity-100 " : " pointer-events-none "
        } justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none transition-all duration-500 px-5 opacity-0 `}
      >
