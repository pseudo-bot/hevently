	...
	return (
		<>
			<div
				...
				} justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none  px-5 animate__animated animate__fadeIn top-16 `}
			>
					...
					<div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
						...
						<div className="flex flex-col px-10 py-8 space-y-6">
							<TextField
								...
								autoComplete = "no"
							/>
							<Button onClick={handleClick} variant="contained" className='capitalize poppins'>
								Confirm Event Name
							</Button>
						</div>
					</div>
