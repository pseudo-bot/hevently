	...
	return (
		<>
			<div
				...
				} justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none transition-all duration-500 px-4`}
			>
				<div className="relative o myw-aut-6 mx-auto max-w-3x bg-bgray-50 bg-gra rounded-2xl">
					<div className="border-0 rounded-2xl shadow-md relative flex flex-col w-full bg-white outline-none focus:outline-none">
						...
						<div className="flex flex-col px-16 py-4 space-y-6">
							...
							<Divider><span className="font-semibold text-gray-600">OR</span></Divider>
							<button
							...
							<button
								...
								onClick={() => setShowLogin(false)}
							>
								<AiFillFacebook className=" text-2xl text-gray-50 mr-4" />
